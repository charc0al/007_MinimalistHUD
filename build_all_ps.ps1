...
$psButtonsRoot = Join-Path $projectRoot "buttons\ps"
...
Write-Step "Copying PS button overrides into src"
Copy-PlatformButtonOverrides -SourceRoot $psButtonsRoot -DestinationRoot $srcRoot
