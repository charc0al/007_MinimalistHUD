      ...
      public static function redrawBitmaps(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               _loc5_ = new ButtonTemplateOpenVR();
               _loc5_.gotoAndStop(_loc4_.idArchetype);
               ...
               if(_loc7_ != null)
               {
                  ...
                  {
                     _loc10_ = PX_TEMPLATE_LABELTEXT_MAX_WIDTH / _loc7_.textWidth;
                     _loc11_ = _loc10_ > 0.5 ? 1 : _loc10_ + 0.5;
               ...
               _loc9_ = new Matrix();
               _loc9_.scale(PX_BITMAP_SIZE / PX_TEMPLATE_SIZE,PX_BITMAP_SIZE / PX_TEMPLATE_SIZE);
