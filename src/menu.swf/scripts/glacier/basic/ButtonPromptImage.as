   ...
   public class ButtonPromptImage extends BaseControl
   {
      ...
      public function set customKey(param1:String) : void
      {
         ...
         else
         {
            ...
            _loc3_.size = this.m_view.button_mc.key_txt.defaultTextFormat.size;
            this.m_view.button_mc.key_txt.setTextFormat(_loc3_);
         }
      ...
      private function localizeKey(param1:String) : void
      {
         ...
         if(this.m_view.button_mc.button_txt != null)
         {
            ...
            else
            {
               ...
               _loc4_.leading = -7;
               this.m_view.button_mc.button_txt.setTextFormat(_loc4_);
