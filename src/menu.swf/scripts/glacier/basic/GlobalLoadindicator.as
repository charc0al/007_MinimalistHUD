package glacier.basic
{
   ...
   public class GlobalLoadindicator extends BaseControl implements IGlobalLoadindicator
   {
      ...
      public function ShowLoadindicator(param1:Object) : void
      {
         ...
         MenuUtils.setupIcon(this.m_view.loadindicator.icon,param1.icon,MenuConstants.COLOR_BLACK,false,true,MenuConstants.COLOR_WHITE,1,0,true);
      ...
      public function setText(param1:String) : void
      {
         ...
         var _loc4_:Boolean = MenuUtils.setupTextAndShrinkToFitUpper(this.m_view.loadindicator.header,param1,18,MenuConstants.FONT_TYPE_MEDIUM,this.m_view.loadindicator.header.width,_loc2_,_loc3_,MenuConstants.FontColorWhite);
         if(!_loc4_)
         {
